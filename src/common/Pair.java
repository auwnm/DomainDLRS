...
public class Pair<A, B> {
	...
	/**
	 * Returns true if this pair equals another pair (this corresponding to the
	 * equal() method evaluating to true for the individual elements).
	 * 
	 * @param t
	...
	public String toString() {
		return "Pair<" + first.getClass().getName() + "," + second.getClass().getName() + ">[" + first + "," + second
				+ "]";
	}
}