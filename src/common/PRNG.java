...
/**
 * Extension of a Mersenne twister pseudo-random number generator. In the
 * future, may be used for adding functionality like specialised serialisation,
 * statistics, etc.
 * 
...
public class PRNG extends MersenneTwisterRNG {
	...
	/**
	 * Constructor. Uses the specified seed data by converting the int to a byte
	 * array.
	 * 
	 * @param seed
	 *            the seed data.
	...
	/**
	 * Constructor. Uses a seed using the specified seed generator.
	 * 
	 * @param seedGenerator
	 *            the seed generator.
