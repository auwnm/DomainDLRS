...
public class ChiSquared {
	...
	/**
	 * Quantile function for the chi^2 distribution, i.e. the inverse, F^-1(p), of
	 * its CDF, F.
	 * <p/>
	 * Algorithm AS 91. Reference: Best & Roberts, 1975, Appl. Statist 24(3):385-388
	 * <p/>
	 * This method is also known as <code>ppchi2()</code>.
	 * 
	 * @param p
	 *            the probability. For numerical reasons, must be in range
	 *            [0.000002,0.999998].
	 * @param k
