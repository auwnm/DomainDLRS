...
/**
 * Not a normal (Gaussian) distribution per se; contains related functions
 * however.
 * 
...
public class Normal {
	...
	/**
	 * Quantile function for a N(0,1) distribution, i.e. the inverse, F^-1(p), of
	 * the CDF, F.
	 * <p/>
